...
def index():
	...
	return render_template('frontpage.html', items = items, permission = True)
...
def gconnect():
    ...
    open('secrets/google.json', 'r').read())['web']['client_id']
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('secrets/google.json', scope='')
...
def fbconnect():
    ...
    app_id = json.loads(open('secrets/facebook.json', 'r').read())[
        'web']['app_id']
    app_secret = json.loads(
        open('secrets/facebook.json', 'r').read())['web']['app_secret']
